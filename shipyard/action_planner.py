...
def _build_action_plan_prompt(state: ShipyardState) -> str:
    ...
    lines = [
        ...
        "4. VERIFY: run_command to try running the code (e.g. 'node -e \"require(\\\"./api/src/app\\\")\"' or 'npx tsx api/src/index.ts'). If it fails, read the error, fix the file, and verify again.",
        "IMPORTANT: After creating or editing files, ALWAYS verify imports match exports. Read both the importing file and the exporting file to confirm the names match.",
